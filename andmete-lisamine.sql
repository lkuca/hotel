...
insert into room(number,name,status)
values(12,'k','active');
insert into room(number,name,status)
values(34,'l','active');
insert into room(number,name,status)
values(56,'v','deactive');
insert into room(number,name,status)
values(13,'c','active');
insert into room(number,name,status)
values(72,'m','deactive');


insert into ocupied_room(check_in,check_out)
values('2001-02-10','2001-02-20');
insert into ocupied_room(check_in,check_out)
values('2002-02-10','2002-02-12');
insert into ocupied_room(check_in,check_out)
values('2003-02-10','2003-02-1');
insert into ocupied_room(check_in,check_out)
values('2004-02-10','2004-02-21');
insert into ocupied_room(check_in,check_out)
values('2005-02-10','2005-02-28');
